...
while True:
    ...
    for Key in frame.electromyographyData.EmgData:
        print(Key)         #打印肌电名称
        print(frame.electromyographyData.EmgData[Key])  #打印肌电数值
   ...
   #自定义骨骼信息
    ...
    cameraObject = frame.CameraObject
    for Key in cameraObject.CameraObjectsData:
        print("CameraSn: ",Key)            #打印相机SN号
        Objects = cameraObject.CameraObjectsData[Key].objects
        for ObjectData in Objects:
            print("ObjectX: ",ObjectData.X) #打印Object坐标X
            print("ObjectY: ",ObjectData.Y) #打印Object坐标Y
